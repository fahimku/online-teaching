                            ...
                            <div class="col col-lg-3 col-md-3 col-sm-6">
                                <div class="widget about-widget">
                                    <div class="logo widget-title">
                                        <img src="<?php bloginfo('template_url'); ?>/images/logo.png" alt="blog">
                                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col col-xs-12">
                                <p class="copyright">&copy; 2022 Ummah. All rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- All JavaScript files
    ...
    <script src="<?php bloginfo('template_url'); ?>/js/circle-progress.min.js"></script>
